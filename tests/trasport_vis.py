...
solute_fieldspvd = PVDReader(registrationName='solute_fields.pvd', FileName='/home/jb/workspace/Endorse/tests/sandbox/edz_pos02/output/L00_S0000006/output/solute_fields.pvd')
...
# create a new 'PVD Reader'
flow_fieldspvd = PVDReader(registrationName='flow_fields.pvd', FileName='/home/jb/workspace/Endorse/tests/sandbox/edz_pos02/output/L00_S0000006/output/flow_fields.pvd')
