...
\end{description}
Není jasné co je v~pracech myšleno pojmem \uv{reverzibilní změny}, jelikož i elasticky reverzibilní deformace jsou reálně ireverzibilní (nedojde k obnově původního napětí).
