...
\begin{itemize}
 ...
 \item Tenzor permeability $\kappa$ bude uvažován jako náhodné korelované pole jehož parametry, zejména střední velikost a anisotropie budou 
 výsledkem modelu EDZ (viz. Sekce \ref{sec:micro_EDZ}).
 \item Porozita $\theta$ bude určena podobným způsobem a korelovaná s vodivostí ve smyslu vztahu Carman-Kožený, viz. \cite{Carrier2003}.
...
Hlavní napětí (vlastní čísla tenzoru $\sigma$) pak ozačíme $\sigma_3 \geq \sigma_2 \geq \sigma_1$.
...
Při použití víceškálového přístupu, viz. sekce \ref{\label{sec:mikroskala}, lze uvažovat parametry jako skalární náhodné veličiny a
...
\begin{itemize}
 \item {\df puklinová síť} - četnosti, orientace, velikost a rozevření puklin
